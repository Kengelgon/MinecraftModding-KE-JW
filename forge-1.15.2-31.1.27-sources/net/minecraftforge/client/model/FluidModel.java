...
{
    public static final FluidModel WATER = new FluidModel(Fluids.field_204546_a);
    public static final FluidModel LAVA = new FluidModel(Fluids.field_204547_b);
    ...
    private static class BakedFluid implements IBakedModel
    {
        ...
        private ImmutableMap<Direction, ImmutableList<BakedQuad>> buildQuads(boolean statePresent, int[] cornerRound, int flowRound, boolean[] sideOverlays)
        {
            ...
            if (statePresent)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    Direction side = Direction.func_176731_b((5 - i) % 4); // [W, S, E, N]
        ...
        private void putVertex(IVertexConsumer consumer, Direction side, boolean offset, float x, float y, float z, float u, float v)
        {
            ...
            {
                switch(elements.get(e).func_177375_c())
                {
                case POSITION:
                ...
                case NORMAL:
                    ...
                    break;
                case UV:
                    if(elements.get(e).func_177369_e() == 0)
                    {
