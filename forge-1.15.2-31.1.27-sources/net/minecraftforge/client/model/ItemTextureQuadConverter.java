...
public final class ItemTextureQuadConverter
{
            ...
            for (int y = 0; y < h; y++)
            {
                ...
                if (start >= 0 && !isVisible)
                {
                    ...
                    while (sameColumn && endX < w)
                    {
                        for (int i = 0; i < h; i++)
                        {
                            if (template.func_195662_a(0, x, i) != template.func_195662_a(0, endX, i))
                            {
                                sameColumn = false;
                                break;
                            }
                                  ...
                                  float x, float y, float z, float u, float v, int color)
    {
        ...
        {
            switch (format.func_227894_c_().get(e).func_177375_c())
            {
                case POSITION:
                ...
                case NORMAL:
                    ...
                    break;
                case UV:
                    if (format.func_227894_c_().get(e).func_177369_e() == 0)
                    {
