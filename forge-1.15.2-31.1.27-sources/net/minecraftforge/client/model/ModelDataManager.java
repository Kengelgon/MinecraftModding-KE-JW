...
public class ModelDataManager
{
    ...
    public static void requestModelDataRefresh(TileEntity te)
    {
        ...
        cleanCaches(world);
        needModelDataRefresh.computeIfAbsent(new ChunkPos(te.func_174877_v()), $ -> Collections.synchronizedSet(new HashSet<>()))
                            .add(te.func_174877_v());
    }
    ...
    {
        if (!event.getChunk().getWorldForge().func_201670_d()) return;
