...
public class LightUtil
{
    ...
    public static void putBakedQuad(IVertexConsumer consumer, BakedQuad quad)
    {
        ...
        VertexFormat formatTo = DefaultVertexFormats.field_176600_a;
    ...
    public static void unpack(int[] from, float[] to, VertexFormat formatFrom, int v, int e)
    {
        ...
        int vertexStart = v * formatFrom.func_177338_f() + formatFrom.getOffset(e);
    ...
    public static void pack(float[] from, int[] to, VertexFormat formatTo, int v, int e)
    {
        ...
        int vertexStart = v * formatTo.func_177338_f() + formatTo.getOffset(e);
        int count = element.func_177370_d();
        VertexFormatElement.Type type = element.func_177367_b();
        int size = type.func_177395_a();
        int mask = (256 << (8 * (size - 1))) - 1;
    ...
    public static class ItemConsumer extends VertexTransformer
    {
        ...
        {
            if(getVertexFormat().func_227894_c_().get(element).func_177375_c() == VertexFormatElement.Usage.COLOR)
            {
