...
public class VertexBufferConsumer implements IVertexConsumer
{
    ...
    {
        return DefaultVertexFormats.field_176600_a; // renderer.getVertexFormat();
    }
    ...
    {
        if (quadData == null || getVertexFormat().func_177338_f() != quadData.length)
        {
            quadData = new int[getVertexFormat().func_177338_f()];
        }
    }
