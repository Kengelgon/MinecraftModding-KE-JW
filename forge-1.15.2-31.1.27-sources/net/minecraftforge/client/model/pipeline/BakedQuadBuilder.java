...
public class BakedQuadBuilder implements IVertexConsumer
{
    ...
    public BakedQuad build()
    {
        ...
        if(contractUVs)
        {
            ...
            int uve = 0;
            ImmutableList<VertexFormatElement> elements = DefaultVertexFormats.field_176600_a.func_227894_c_();
        ...
        for (int v = 0; v < 4; v++)
        {
            ...
            {
                LightUtil.pack(unpackedData[v][e], packed, DefaultVertexFormats.field_176600_a, v, e);
            }
        }
