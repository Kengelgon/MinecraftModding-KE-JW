...
public class BlockInfo
{
    ...
    public void updateLightMatrix()
    {
        for(int x = 0; x <= 2; x++)
        {
            for(int y = 0; y <= 2; y++)
            {
                for(int z = 0; z <= 2; z++)
                {
                    ...
                    t[x][y][z] = state.func_200016_a(world, pos) < 15;
        ...
        {
            BlockPos pos = blockPos.func_177972_a(side);
            BlockState state = world.func_180495_p(pos);
            ...
            BlockState otherStateShape = state.func_200132_m() && state.func_215691_g() ? state : Blocks.field_150350_a.func_176223_P();

            if(state.func_200016_a(world, blockPos) == 15 || VoxelShapes.func_223416_b(thisStateShape.func_215702_a(world, blockPos, side), otherStateShape.func_215702_a(world, pos, side.func_176734_d())))
            {
    ...
    {
        full = Block.func_208062_a(state.func_196952_d(world, blockPos));
