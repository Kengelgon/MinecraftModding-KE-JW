...
public class VertexLighterFlat extends QuadGatheringTransformer
{
    ...
    private void updateIndices()
    {
        ...
        {
            switch(getVertexFormat().func_227894_c_().get(i).func_177375_c())
            {
                case POSITION:
                    posIndex = i;
                    break;
                ...
                case COLOR:
                    ...
                    break;
                case UV:
                    if(getVertexFormat().func_227894_c_().get(i).func_177369_e() == 2)
                    {
                        lightmapIndex = i;
                    }
                    break;
    ...
    protected void processQuad()
    {
        ...
        else // normals must be generated
        {
            ...
            for(int v = 0; v < 4; v++)
            {
                normal[v][0] = v2.func_195899_a();
                normal[v][1] = v2.func_195900_b();
                normal[v][2] = v2.func_195902_c();
                normal[v][3] = 0;
            }
        }
