...
public enum B3DLoader implements ISelectiveResourceReloadListener
{
            ...
            try
            {
                ...
                catch(FileNotFoundException e)
                {
                    if(modelLocation.func_110623_a().startsWith("models/block/"))
                        resource = manager.func_199002_a(new ResourceLocation(file.func_110624_b(), "models/item/" + file.func_110623_a().substring("models/block/".length())));
                    else if(modelLocation.func_110623_a().startsWith("models/item/"))
                        resource = manager.func_199002_a(new ResourceLocation(file.func_110624_b(), "models/block/" + file.func_110623_a().substring("models/item/".length())));
                    else throw e;
                }
    ...
    private static final class ModelWrapper implements IUnbakedModel
    {
        ...
        public Collection<Material> func_225614_a_(Function<ResourceLocation, IUnbakedModel> p_225614_1_, Set<com.mojang.datafixers.util.Pair<String, String>> p_225614_2_)
        {
            return textures.values().stream().filter(loc -> !loc.startsWith("#"))
                    .map(t -> new Material(AtlasTexture.field_110575_b, new ResourceLocation(t)))
        ...
        public IBakedModel func_225613_a_(ModelBakery bakery, Function<Material, TextureAtlasSprite> spriteGetter, IModelTransform modelTransform, ResourceLocation modelLocation)
        {
            ...
            TextureAtlasSprite missing = spriteGetter.apply(new Material(AtlasTexture.field_110575_b, MissingTextureSprite.func_195675_b()));
            for(Map.Entry<String, String> e : textures.entrySet())
            {
                ...
                {
                    builder.put(e.getKey(), spriteGetter.apply(new Material(AtlasTexture.field_110575_b, new ResourceLocation(e.getValue()))));
                }
            }
    ...
    private static final class BakedWrapper implements IDynamicBakedModel
    {
        ...
        private void generateQuads(ImmutableList.Builder<BakedQuad> builder, Node<?> node, final IModelTransform state, ImmutableList<String> path)
        {
            ...
            if(node.getKind() instanceof Mesh && meshes.contains(node.getName()) && state.getPartTransformation(Models.getHiddenModelPart(newPath)).isIdentity())
            {
                ...
                for(Face f : faces)
                {
                    ...
                    quadBuilder.setQuadOrientation(Direction.func_176737_a(f.getNormal().func_195899_a(), f.getNormal().func_195900_b(), f.getNormal().func_195902_c()));
        ...
        private final void putVertexData(IVertexConsumer consumer, Vertex v, Vector3f faceNormal, TextureAtlasSprite sprite)
        {
            ...
            {
                switch(vertexFormatElements.get(e).func_177375_c())
                {
                case POSITION:
                    consumer.put(e, v.getPos().func_195899_a(), v.getPos().func_195900_b(), v.getPos().func_195902_c(), 1);
                    break;
                case COLOR:
                    if(v.getColor() != null)
                    {
                ...
                case UV:
                    ...
                    if(vertexFormatElements.get(e).func_177369_e() < v.getTexCoords().length)
                    {
                        consumer.put(e,
                            sprite.func_94214_a(v.getTexCoords()[0].func_195910_a() * 16),
                            sprite.func_94207_b(v.getTexCoords()[0].func_195913_b() * 16),
                            0,
                            1
                        );
                    }
                ...
                case NORMAL:
                    if(v.getNormal() != null)
                    {
                        consumer.put(e, v.getNormal().func_195899_a(), v.getNormal().func_195900_b(), v.getNormal().func_195902_c(), 0);
                    }
                    else
                    {
                        consumer.put(e, faceNormal.func_195899_a(), faceNormal.func_195900_b(), faceNormal.func_195902_c(), 0);
                    }
                    break;
                default:
                    consumer.put(e);
