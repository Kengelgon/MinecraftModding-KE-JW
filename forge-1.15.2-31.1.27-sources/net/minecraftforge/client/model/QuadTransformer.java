...
public class QuadTransformer
{
    ...
    public BakedQuad processOne(BakedQuad input)
    {
        ...
        return new BakedQuad(outData, input.func_178211_c(), input.func_178210_d(), input.func_187508_a(), input.shouldApplyDiffuseLighting());
    }
    ...
    public List<BakedQuad> processMany(List<BakedQuad> inputs)
    {
        ...
        for(BakedQuad input : inputs)
        {
            ...
            outputs.add(new BakedQuad(outData, input.func_178211_c(), input.func_178210_d(), input.func_187508_a(), input.shouldApplyDiffuseLighting()));
        }
        return outputs;
    }
