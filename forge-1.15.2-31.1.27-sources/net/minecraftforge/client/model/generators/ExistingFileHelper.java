...
public class ExistingFileHelper {
    ...
    public ExistingFileHelper(Collection<Path> existingPacks, boolean enable) {
        ...
        this.clientResources.func_199021_a(new VanillaPack("minecraft", "realms"));
        this.serverData.func_199021_a(new VanillaPack("minecraft"));
        for (Path existing : existingPacks) {
            ...
            this.clientResources.func_199021_a(pack);
            this.serverData.func_199021_a(pack);
        };
        this.enable = enable;
    }
    ...
    public boolean exists(ResourceLocation loc, ResourcePackType type, String pathSuffix, String pathPrefix) {
        ...
        return getManager(type).func_219533_b(getLocation(loc, pathSuffix, pathPrefix));
    }
    ...
    public IResource getResource(ResourceLocation loc, ResourcePackType type, String pathSuffix, String pathPrefix) throws IOException {
        return getManager(type).func_199002_a(getLocation(loc, pathSuffix, pathPrefix));
    }
