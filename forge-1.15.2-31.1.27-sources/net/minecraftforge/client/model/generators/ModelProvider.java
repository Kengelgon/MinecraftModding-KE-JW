...
public abstract class ModelProvider<T extends ModelBuilder<T>> implements IDataProvider {
    ...
    private ResourceLocation extendWithFolder(ResourceLocation rl) {
        ...
        return new ResourceLocation(rl.func_110624_b(), folder + "/" + rl.func_110623_a());
    }
    ...
    protected void generateAll(DirectoryCache cache) {
        for (T model : generatedModels.values()) {
            ...
            try {
                IDataProvider.func_218426_a(GSON, cache, model.toJson(), target);
            } catch (IOException e) {
    ...
    private Path getPath(T model) {
        ...
        return generator.func_200391_b().resolve("assets/" + loc.func_110624_b() + "/models/" + loc.func_110623_a() + ".json");
    }
}
