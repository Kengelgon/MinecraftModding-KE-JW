...
public final class MultiPartBlockStateBuilder implements IGeneratedBlockstate {
    ...
    public class PartBuilder {
        ...
        public final <T extends Comparable<T>> PartBuilder condition(IProperty<T> prop, T... values) {
            ...
            Preconditions.checkArgument(!conditions.containsKey(prop), "Cannot set condition for property \"%s\" more than once", prop.func_177701_a());
        ...
        JsonObject toJson() {
            ...
            if (!conditions.isEmpty()) {
                ...
                for (Entry<IProperty<?>, Collection<Comparable<?>>> e : conditions.asMap().entrySet()) {
                    ...
                    when.addProperty(e.getKey().func_177701_a(), activeString.toString());
                }
                if (useOr) {
        ...
        public boolean canApplyTo(Block b) {
            return b.func_176194_O().func_177623_d().containsAll(conditions.keySet());
        }
    }
}
