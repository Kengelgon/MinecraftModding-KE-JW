...
public class ModListWidget extends ExtendedList<ModListWidget.ModEntry>
{
    ...
    {
        super(parent.getMinecraftInstance(), listWidth, parent.height, top, bottom, parent.getFontRenderer().field_78288_b * 2 + 8);
        this.parent = parent;
    ...
    public class ModEntry extends ExtendedList.AbstractListEntry<ModEntry> {
        ...
        public void render(int entryIdx, int top, int left, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean p_194999_5_, float partialTicks)
        {
            ...
            font.func_211126_b(font.func_78269_a(name, listWidth),left + 3, top + 2, 0xFFFFFF);
            font.func_211126_b(font.func_78269_a(version, listWidth), left + 3 , top + 2 + font.field_78288_b, 0xCCCCCC);
