    ...
    public void render(int mouseX, int mouseY, float partial)
    {
        if (this.visible)
        {
            ...
            if (totalWidth > width - 6 && totalWidth > ellipsisWidth)
                buttonText = mc.field_71466_p.func_78269_a(buttonText, width - 6 - ellipsisWidth).trim() + "...";
            ...
            this.drawCenteredString(mc.field_71466_p, glyph,
            ...
            this.drawCenteredString(mc.field_71466_p, buttonText, (int) (this.x + (this.width / 2) + (glyphWidth / glyphScale)),
