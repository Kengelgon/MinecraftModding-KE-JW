...
public class TextComponentHelper
{
    ...
    public static TextComponent createComponentTranslation(ICommandSource source, final String translation, final Object... args)
    {
        ...
        {
            return new StringTextComponent(String.format(LanguageMap.func_74808_a().func_74805_b(translation), args));
        }
    ...
    private static boolean isVanillaClient(ICommandSource sender)
    {
        if (sender instanceof ServerPlayerEntity)
        {
            ...
            ServerPlayNetHandler channel = playerMP.field_71135_a;
            return NetworkHooks.getConnectionType(()->channel.field_147371_a) == ConnectionType.VANILLA;
        }
        return false;
    }
}
