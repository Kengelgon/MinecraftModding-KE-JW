...
final class ConsoleCommandCompleter implements Completer
{
    ...
    public void complete(LineReader reader, ParsedLine line, List<Candidate> candidates)
    {
        ...
        try
        {
            ParseResults<CommandSource> results = this.server.func_195571_aL().func_197054_a().parse(stringReader, this.server.func_195573_aM());
            Suggestions tabComplete = this.server.func_195571_aL().func_197054_a().getCompletionSuggestions(results).get();
