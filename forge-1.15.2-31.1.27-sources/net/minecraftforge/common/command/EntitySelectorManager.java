...
public class EntitySelectorManager
{
    ...
    {
        if (parser.func_197398_f().canRead())
        {
            int i = parser.func_197398_f().getCursor();
            String token = parser.func_197398_f().readUnquotedString();
            ...
            parser.func_197398_f().setCursor(i);
        }
