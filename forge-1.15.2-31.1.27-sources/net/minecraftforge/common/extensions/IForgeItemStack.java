...
public interface IForgeItemStack extends ICapabilitySerializable<CompoundNBT>
{
    ...
    {
        return getStack().func_77973_b().getHarvestLevel(getStack(), tool, player, state);
    }
    ...
    default ActionResultType onItemUseFirst(ItemUseContext context)
    {
       ...
       CachedBlockInfo blockworldstate = new CachedBlockInfo(context.func_195991_k(), blockpos, false);
       if (entityplayer != null && !entityplayer.field_71075_bZ.field_75099_e && !getStack().func_206847_b(context.func_195991_k().func_205772_D(), blockworldstate)) {
          return ActionResultType.PASS;
       } else {
          Item item = getStack().func_77973_b();
          ...
          if (entityplayer != null && enumactionresult == ActionResultType.SUCCESS) {
             entityplayer.func_71029_a(Stats.field_75929_E.func_199076_b(item));
          }
    ...
    {
        return !getStack().func_190926_b() && getStack().func_77973_b().onBlockStartBreak(getStack(), pos, player);
    }
    ...
    {
        return getStack().func_77973_b().shouldCauseBlockBreakReset(getStack(), newStack);
    }
    ...
    {
        return getStack().func_77973_b().canDisableShield(getStack(), shield, entity, attacker);
    }
    ...
    {
        return getStack().func_77973_b().isShield(getStack(), entity);
    }
    ...
    {
        return getStack().func_77973_b().onEntitySwing(getStack(), entity);
    }
    ...
    {
        getStack().func_77973_b().onUsingTick(getStack(), player, count);
    }
    ...
    {
        return getStack().func_77973_b().onEntityItemUpdate(getStack(), entity);
    }
    ...
    */
    ...
    {
        getStack().func_77973_b().onArmorTick(getStack(), world, player);
    }
    ...
    {
        getStack().func_77973_b().onHorseArmorTick(getStack(), world, horse);
    }
    ...
    {
        return getStack().func_77973_b().canEquip(getStack(), armorType, entity);
    }
    ...
    {
        return getStack().func_77973_b().isBookEnchantable(getStack(), book);
    }
    ...
    {
        return getStack().func_77973_b().onDroppedByPlayer(getStack(), player);
    }
    ...
    {
        return getStack().func_77973_b().getHighlightTip(getStack(), displayName);
    }
    ...
    {
        getStack().func_77973_b().readShareTag(getStack(), nbt);
    }
    ...
    {
        return getStack().func_190926_b() || getStack().func_77973_b().doesSneakBypassUse(getStack(), world, pos, player);
    }
    ...
    default boolean equals(ItemStack other, boolean limitTags)
    {
        if (getStack().func_190926_b())
            ...
            return !other.func_190926_b() && getStack().func_190916_E() == other.func_190916_E() && getStack().func_77973_b() == other.func_77973_b() &&
            (limitTags ? getStack().areShareTagsEqual(other) : ItemStack.func_77970_a(getStack(), other));
    }
