...
public interface IForgeEntity extends ICapabilitySerializable<CompoundNBT>
{
    ...
    {
        getEntity().func_70020_e(nbt);
    }

    default CompoundNBT serializeNBT()
    {
        CompoundNBT ret = new CompoundNBT();
        String id = getEntity().func_70022_Q();
        if (id != null)
        {
            ret.func_74778_a("id", getEntity().func_70022_Q());
        }
        return getEntity().func_189511_e(ret);
    }
    ...
    default ItemStack getPickedResult(RayTraceResult target)
    {
        ...
        {
            SpawnEggItem egg = SpawnEggItem.func_200889_b(getEntity().func_200600_R());
