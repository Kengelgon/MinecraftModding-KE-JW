...
public interface IForgeItem
{
    ...
    {
        return getItem().func_111205_h(slot);
    }
    ...
    */
    ...
    default ItemStack getContainerItem(ItemStack itemStack)
    {
        ...
        return new ItemStack(getItem().func_77668_q());
    }
    ...
    {
        return java.util.Collections.singletonList(getItem().func_77640_w());
    }
    ...
    {
        return MobEntity.func_184640_d(stack) == armorType;
    }
    ...
    {
        return getItem().func_150897_b(state);
    }
    ...
    {
        return Tags.Items.BEACON_PAYMENT.func_199685_a_(stack.func_77973_b());
    }
    ...
    {
        return !(newStack.func_77973_b() == oldStack.func_77973_b() && ItemStack.func_77970_a(newStack, oldStack)
                && (newStack.func_77984_f() || newStack.func_77952_i() == oldStack.func_77952_i()));
    }
    ...
    {
        return ItemStack.func_185132_d(oldStack, newStack);
    }
    ...
    default ImmutableMap<String, ITimeValue> getAnimationParameters(final ItemStack stack, final World world, final LivingEntity entity)
    {
        ...
        getItem().field_185051_m.forEach((k,v) -> builder.put(k.toString(), input -> v.call(stack, world, entity)));
