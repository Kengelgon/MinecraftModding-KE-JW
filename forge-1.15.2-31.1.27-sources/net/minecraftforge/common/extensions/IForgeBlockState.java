...
public interface IForgeBlockState
{
    ...
    {
        return getBlockState().func_177230_c().getSlipperiness(getBlockState(), world, pos, entity);
    }
    ...
    {
        return getBlockState().func_177230_c().getLightValue(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().isLadder(getBlockState(), world, pos, entity);
    }
    ...
    {
        return getBlockState().func_177230_c().createTileEntity(getBlockState(), world);
    }
    ...
    {
        return getBlockState().func_177230_c().canHarvestBlock(getBlockState(), world, pos, player);
    }
    ...
    {
        return getBlockState().func_177230_c().removedByPlayer(getBlockState(), world, pos, player, willHarvest, fluid);
    }
    ...
    {
        return getBlockState().func_177230_c().isBed(getBlockState(), world, pos, player);
    }
    ...
    {
        return getBlockState().func_177230_c().canCreatureSpawn(getBlockState(), world, pos, type, entityType);
    }
    /**
    ...
    {
        return getBlockState().func_177230_c().getBedSpawnPosition(type, getBlockState(), world, pos, sleeper);
    }
    ...
    {
        getBlockState().func_177230_c().setBedOccupied(getBlockState(), world, pos, sleeper, occupied);
    }
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().getBedDirection(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().isBedFoot(getBlockState(), world, pos);
    }
    ...
    {
        getBlockState().func_177230_c().beginLeaveDecay(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().isAir(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().canBeReplacedByLeaves(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().canBeReplacedByLogs(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().isReplaceableOreGen(getBlockState(), world, pos, target);
    }
    ...
    {
        return getBlockState().func_177230_c().getExplosionResistance(getBlockState(), world, pos, exploder, explosion);
    }
    ...
    {
        return getBlockState().func_177230_c().canConnectRedstone(getBlockState(), world, pos, side);
    }
    ...
    {
        return getBlockState().func_177230_c().getPickBlock(getBlockState(), target, world, pos, player);
    }
    ...
    {
        return getBlockState().func_177230_c().isFoliage(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().addLandingEffects(getBlockState(), worldserver, pos, state2, entity, numberOfParticles);
    }
   /**
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().addRunningEffects(getBlockState(), world, pos, entity);
    }
    ...
    {
        return getBlockState().func_177230_c().addHitEffects(getBlockState(), world, target, manager);
    }
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().addDestroyEffects(getBlockState(), world, pos, manager);
    }
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().canSustainPlant(getBlockState(), world, pos, facing, plantable);
    }
    ...
    {
        getBlockState().func_177230_c().onPlantGrow(getBlockState(), world, pos, source);
    }
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().isFertile(getBlockState(), world, pos);
    }
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().isBeaconBase(getBlockState(), world, pos, beacon);
    }
    ...
    {
        return getBlockState().func_177230_c().isConduitFrame(getBlockState(), world, pos, conduit);
    }
    ...
    {
        return getBlockState().func_177230_c().isPortalFrame(getBlockState(), world, pos);
    }
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().getExpDrop(getBlockState(), world, pos, fortune, silktouch);
    }

    default BlockState rotate(IWorld world, BlockPos pos, Rotation direction)
    {
        return getBlockState().func_177230_c().rotate(getBlockState(), world, pos, direction);
    }
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().getEnchantPowerBonus(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().recolorBlock(getBlockState(), world, pos, facing, color);
    }
    ...
    */
    ...
    {
        getBlockState().func_177230_c().onNeighborChange(getBlockState(), world, pos, neighbor);
    }
    ...
    */
    ...
    {
        getBlockState().func_177230_c().observedNeighborChange(getBlockState(), world, pos, changed, changedPos);
    }
    ...
    */
    ...
    {
        return getBlockState().func_177230_c().shouldCheckWeakPower(getBlockState(), world, pos, side);
    }
    ...
    {
        return getBlockState().func_177230_c().getWeakChanges(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().isToolEffective(getBlockState(), tool);
    }
    ...
    {
        return getBlockState().func_177230_c().getSoundType(getBlockState(), world, pos, entity);
    }
    ...
    {
        return getBlockState().func_177230_c().getBeaconColorMultiplier(getBlockState(), world, pos, beacon);
    }
    ...
    {
        return getBlockState().func_177230_c().getFogColor(getBlockState(), world, pos, entity, originalColor, partialTicks);
    }
    ...
    {
        return getBlockState().func_177230_c().getStateAtViewpoint(getBlockState(), world, pos, viewpoint);
    }
    ...
    {
        return getBlockState().func_177230_c().getStateForPlacement(getBlockState(), facing, state2, world, pos1, pos2, hand);
    }
    ...
    {
        return getBlockState().func_177230_c().canBeConnectedTo(getBlockState(), world, pos, facing);
    }
    ...
    {
        return getBlockState().func_177230_c().canStickTo(getBlockState(), other);
    }
    ...
    {
        return getBlockState().func_177230_c().getFlammability(getBlockState(), world, pos, face);
    }
    ...
    {
        return getBlockState().func_177230_c().isFlammable(getBlockState(), world, pos, face);
    }
    ...
    {
        getBlockState().func_177230_c().catchFire(getBlockState(), world, pos, face, igniter);
    }
    ...
    {
        return getBlockState().func_177230_c().getFireSpreadSpeed(getBlockState(), world, pos, face);
    }
    ...
    {
        return getBlockState().func_177230_c().isFireSource(getBlockState(), world, pos, side);
    }
    ...
    {
        return getBlockState().func_177230_c().canEntityDestroy(getBlockState(), world, pos, entity);
    }
    ...
    {
        return getBlockState().func_177230_c().getValidRotations(getBlockState(), world, pos);
    }
    ...
    {
       return getBlockState().func_177230_c().isBurning(getBlockState(), world, pos);
    }
    ...
    {
        return getBlockState().func_177230_c().getAiPathNodeType(getBlockState(), world, pos, entity);
    }
    ...
    {
        return getBlockState().func_177230_c().canDropFromExplosion(getBlockState(), world, pos, explosion);
    }
    ...
    {
        getBlockState().func_177230_c().onBlockExploded(getBlockState(), world, pos, explosion);
    }
    ...
    {
        return getBlockState().func_177230_c().collisionExtendsVertically(getBlockState(), world, pos, collidingEntity);
    }
    ...
    {
        return getBlockState().func_177230_c().shouldDisplayFluidOverlay(getBlockState(), world, pos, fluidState);
    }
}
