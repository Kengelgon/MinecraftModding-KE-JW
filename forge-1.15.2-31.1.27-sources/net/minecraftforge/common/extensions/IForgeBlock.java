...
public interface IForgeBlock
{
    ...
    default TileEntity createTileEntity(BlockState state, IBlockReader world)
    {
        if (getBlock() instanceof ITileEntityProvider)
            return ((ITileEntityProvider)getBlock()).func_196283_a_(world);
        return null;
    }
    ...
    {
        getBlock().func_176208_a(world, pos, state, player);
    ...
    default void setBedOccupied(BlockState state, IWorldReader world, BlockPos pos, LivingEntity sleeper, boolean occupied)
    {
        ...
        {
            ((IWorldWriter)world).func_180501_a(pos, state.func_206870_a(BedBlock.field_176471_b,occupied), 4);
        }
    }
    ...
    */
    ...
    {
        return state.func_177229_b(HorizontalBlock.field_185512_D);
    }
    ...
    {
        return state.func_177229_b(BedBlock.field_176472_a) == BedPart.FOOT;
    }
    ...
    {
        return isAir(state, world, pos) || state.func_203425_a(BlockTags.field_206952_E);
    }
    ...
    {
        return (isAir(state, world, pos) || state.func_203425_a(BlockTags.field_206952_E)) || this == Blocks.field_196658_i || state.func_203425_a(net.minecraftforge.common.Tags.Blocks.DIRT)
            || getBlock().func_203417_a(BlockTags.field_200031_h) || getBlock().func_203417_a(BlockTags.field_200030_g) || this == Blocks.field_150395_bd;
    }
    ...
    */
    ...
    {
        if (state.func_203425_a(net.minecraftforge.common.Tags.Blocks.DIRT))
    ...
    */
    default boolean isFertile(BlockState state, IBlockReader world, BlockPos pos)
    {
        if (this.getBlock() == Blocks.field_150458_ak)
            return state.func_177229_b(FarmlandBlock.field_176531_a) > 0;
    ...
    */
    default boolean isBeaconBase(BlockState state, IWorldReader world, BlockPos pos, BlockPos beacon)
    {
        return  state.func_177230_c() == Blocks.field_150339_S ||
                state.func_177230_c() == Blocks.field_150340_R ||
                state.func_177230_c() == Blocks.field_150484_ah ||
                state.func_177230_c() == Blocks.field_150475_bE;
    }
    ...
    {
        return  state.func_177230_c() == Blocks.field_180397_cI ||
                state.func_177230_c() == Blocks.field_196779_gQ ||
                state.func_177230_c() == Blocks.field_180398_cJ ||
                state.func_177230_c() == Blocks.field_196781_gR;
    }
    ...
    {
        return state.func_177230_c() == Blocks.field_150343_Z;
    }
    ...
    */
    ...
    default Direction[] getValidRotations(BlockState state, IBlockReader world, BlockPos pos)
    {
        ...
        {
            if ((prop.func_177701_a().equals("facing") || prop.func_177701_a().equals("rotation")) && prop.func_177699_b() == Direction.class)
            {
                @SuppressWarnings("unchecked")
                Collection<Direction> values = ((Collection<Direction>)prop.func_177700_c());
    ...
    */
    ...
    {
        return this.getBlock() == Blocks.field_150342_X ? 1: 0;
    }
    ...
    */
    ...
    default boolean recolorBlock(BlockState state, IWorld world, BlockPos pos, Direction facing, DyeColor color)
    {
        for (IProperty<?> prop : state.func_206869_a())
        {
            if (prop.func_177701_a().equals("color") && prop.func_177699_b() == DyeColor.class)
            {
                DyeColor current = (DyeColor)state.func_177229_b(prop);
                if (current != color && prop.func_177700_c().contains(color))
                {
                    world.func_180501_a(pos, state.func_206870_a(((IProperty<DyeColor>)prop), color), 3);
                    return true;
                }
            }
        }
    ...
    */
    ...
    default float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos)
    {
        if (getBlock() instanceof IBeaconBeamColorProvider)
            return ((IBeaconBeamColorProvider)getBlock()).func_196457_d().func_193349_f();
        return null;
    }
    ...
    default Vec3d getFogColor(BlockState state, IWorldReader world, BlockPos pos, Entity entity, Vec3d originalColor, float partialTicks)
    {
        if (state.func_185904_a() == Material.field_151586_h)
        {
            ...
            if (entity instanceof LivingEntity)
            {
                ...
                f12 = (float) EnchantmentHelper.func_185292_c(ent) * 0.2F;
    ...
    {
        if (state.func_177230_c() == Blocks.field_226907_mc_ && other.func_177230_c() == Blocks.field_180399_cE) return false;
        if (state.func_177230_c() == Blocks.field_180399_cE && other.func_177230_c() == Blocks.field_226907_mc_) return false;
    ...
    default boolean isFireSource(BlockState state, IBlockReader world, BlockPos pos, Direction side)
    {
        ...
        if (getBlock() == Blocks.field_150424_aL || getBlock() == Blocks.field_196814_hQ)
            return true;
        if (world instanceof IWorldReader && ((IWorldReader)world).func_201675_m() instanceof EndDimension && getBlock() == Blocks.field_150357_h)
            return true;
        return false;
    }
    ...
    default boolean canEntityDestroy(BlockState state, IBlockReader world, BlockPos pos, Entity entity)
    {
        ...
        {
            return !BlockTags.field_219754_W.func_199685_a_(this.getBlock());
        }
        else if ((entity instanceof WitherEntity) ||
                 (entity instanceof WitherSkullEntity))
        {
            return state.isAir(world, pos) || WitherEntity.func_181033_a(state);
        }
    ...
    default void onBlockExploded(BlockState state, World world, BlockPos pos, Explosion explosion)
    {
        ...
        getBlock().func_180652_a(world, pos, explosion);
    }
    ...
    {
        return state.func_177230_c() == Blocks.field_150359_w || state.func_177230_c() instanceof StainedGlassBlock;
    }
}
