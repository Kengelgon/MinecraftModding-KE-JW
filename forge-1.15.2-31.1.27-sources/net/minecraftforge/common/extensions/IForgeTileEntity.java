...
public interface IForgeTileEntity extends ICapabilitySerializable<CompoundNBT>
{
    ...
    {
        getTileEntity().func_145839_a(nbt);
    }
    ...
    default CompoundNBT serializeNBT()
    {
        ...
        getTileEntity().func_189515_b(ret);
        return ret;
    }
     ...
     */
     ...
     {
         getTileEntity().func_145839_a(tag);
     }
     ...
     */
     ...
     default AxisAlignedBB getRenderBoundingBox()
     {
         ...
         BlockState state = getTileEntity().func_195044_w();
         Block block = state.func_177230_c();
         BlockPos pos = getTileEntity().func_174877_v();
         ...
         else if (block != null && block != Blocks.field_150461_bJ)
         {
             ...
             try
             {
                 cbb = state.func_196952_d(getTileEntity().func_145831_w(), pos).func_197752_a().func_186670_a(pos);
             }
             catch (Exception e)
             {
                 ...
                 cbb = new net.minecraft.util.math.AxisAlignedBB(pos.func_177982_a(-1, 0, -1), pos.func_177982_a(1, 1, 1));
             }
             if (cbb != null) bb = cbb;
         }
         return bb;
     ...
     {
         Block block = getTileEntity().func_195044_w().func_177230_c();
