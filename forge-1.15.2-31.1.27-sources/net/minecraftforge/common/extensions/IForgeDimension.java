...
public interface IForgeDimension
{
    ...
    {
        return (getDimension().func_76567_e() && getWorld().func_226691_t_(pos) != Biomes.field_76778_j) ? SleepResult.ALLOW : SleepResult.BED_EXPLODES;
    }
    ...
    {
        return getDimension().func_186058_p() == DimensionType.field_223227_a_ && getWorld().func_175657_ab() < 4;
    }
    ...
    {
        return getWorld().func_226691_t_(pos).func_76736_e();
    }
