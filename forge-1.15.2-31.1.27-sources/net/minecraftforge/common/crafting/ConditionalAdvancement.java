...
public class ConditionalAdvancement
{
    ...
    {
        JsonArray entries = JSONUtils.func_151213_a(json, "advancements", null);
        if (entries == null)
        {
        ...
        for (JsonElement ele : entries)
        {
            ...
            if (CraftingHelper.processConditions(JSONUtils.func_151214_t(ele.getAsJsonObject(), "conditions")))
                return gson.fromJson(JSONUtils.func_152754_s(ele.getAsJsonObject(), "advancement"), Advancement.Builder.class);
            idx++;
        }
        return null;
    }
    ...
    public static class Builder
    {
        ...
        public JsonObject write()
        {
            ...
            for (int x = 0; x < conditions.size(); x++)
            {
                ...
                holder.add("advancement", advancements.get(x).func_200273_b());
