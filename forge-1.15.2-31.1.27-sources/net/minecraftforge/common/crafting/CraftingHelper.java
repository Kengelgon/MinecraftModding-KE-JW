...
public class CraftingHelper
{
    ...
    public static <T extends Ingredient> void write(PacketBuffer buffer, T ingredient)
    {
        ...
        {
            buffer.func_150787_b(-1); //Marker to know there is a custom ingredient
    ...
    public static Ingredient getIngredient(JsonElement json)
    {
        ...
        String type = JSONUtils.func_151219_a(obj, "type", "minecraft:item");
        if (type.isEmpty())
    ...
    {
        String itemName = JSONUtils.func_151200_h(json, "item");
        ...
        return new ItemStack(item, JSONUtils.func_151208_a(json, "count", 1));
    }

    public static boolean processConditions(JsonObject json, String memberName)
    {
        return !json.has(memberName) || processConditions(JSONUtils.func_151214_t(json, memberName));
    }
    ...
    {
        ResourceLocation type = new ResourceLocation(JSONUtils.func_151200_h(json, "type"));
