...
public class TagEmptyCondition implements ICondition
{
    ...
    public boolean test()
    {
        Tag<Item> tag = ItemTags.func_199903_a().func_199910_a(tag_name);
        return tag == null || tag.func_199885_a().isEmpty();
    }
    ...
    public static class Serializer implements IConditionSerializer<TagEmptyCondition>
    {
        ...
        {
            return new TagEmptyCondition(new ResourceLocation(JSONUtils.func_151200_h(json, "tag")));
        }
