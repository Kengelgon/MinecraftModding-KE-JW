...
public class BasicTrade implements ITrade
{
    ...
    {
        this(price, ItemStack.field_190927_a, forSale, maxTrades, xp, priceMult);
    }

    public BasicTrade(int emeralds, ItemStack forSale, int maxTrades, int xp, float mult)
    {
        this(new ItemStack(Items.field_151166_bC, emeralds), forSale, maxTrades, xp, mult);
    }

    public BasicTrade(int emeralds, ItemStack forSale, int maxTrades, int xp)
    {
        this(new ItemStack(Items.field_151166_bC, emeralds), forSale, maxTrades, xp, 1);
    }
