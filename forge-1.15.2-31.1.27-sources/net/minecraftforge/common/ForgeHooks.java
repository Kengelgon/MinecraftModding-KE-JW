...
public class ForgeHooks
{
    ...
    {
        boolean isSpectator = (entity instanceof PlayerEntity && ((PlayerEntity)entity).func_175149_v());
    ...
    public static int onBlockBreakEvent(World world, GameType gameType, ServerPlayerEntity entityPlayer, BlockPos pos)
    {
        ...
        {
            entityPlayer.field_71135_a.func_147359_a(new SChangeBlockPacket(DUMMY_WORLD, pos));
        }
    ...
    public static ActionResultType onPlaceItemIntoWorld(@Nonnull ItemUseContext context)
    {
        ...
        ItemStack copy = itemstack.func_77984_f() ? itemstack.func_77946_l() : null;
    ...
    {
        Vec3d vec3d = ray.func_216347_e().func_178788_d(entity.func_213303_ch());
    ...
    public static List<ItemStack> modifyLoot(List<ItemStack> list, LootContext context) {
        LootModifierManager man = context.func_202879_g().func_73046_m().getLootModifierManager();
