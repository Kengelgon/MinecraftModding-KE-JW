...
public class FluidAttributes
{
    ...
    {
        return new ItemStack(stack.getFluid().func_204524_b());
    }
    ...
    public boolean doesVaporize(ILightReader reader, BlockPos pos, FluidStack fluidStack)
    {
        ...
        if (blockstate == null)
            return false;
        return blockstate.func_185904_a() == net.minecraft.block.material.Material.field_151586_h;
    }
    ...
    public void vaporize(@Nullable PlayerEntity player, World worldIn, BlockPos pos, FluidStack fluidStack)
    {
        ...
        for (int l = 0; l < 8; ++l)
        {
            worldIn.func_195589_b(ParticleTypes.field_197594_E, (double) pos.func_177958_n() + Math.random(), (double) pos.func_177956_o() + Math.random(), (double) pos.func_177952_p() + Math.random(), 0.0D, 0.0D, 0.0D);
        }
    }
