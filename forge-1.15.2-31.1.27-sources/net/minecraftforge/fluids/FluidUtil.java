...
public class FluidUtil
{
    ...
    public static boolean tryPlaceFluid(@Nullable PlayerEntity player, World world, Hand hand, BlockPos pos, IFluidHandler fluidSource, FluidStack resource)
    {
        ...
        BlockItemUseContext context = new BlockItemUseContext(new ItemUseContext(player, hand, new BlockRayTraceResult(Vec3d.field_186680_a, Direction.UP, pos, false))); //TODO: This neds proper context...

        // check that we can place the fluid at the destination
        BlockState destBlockState = world.func_180495_p(pos);
        ...
        if (world.field_73011_w.func_177500_n() && fluid.getAttributes().doesVaporize(world, pos, resource))
        {
    ...
    {
        BlockState state = fluid.getAttributes().getBlock(world, pos, fluid.func_207188_f());
