...
public class FluidHandlerItemStackSimple implements IFluidHandlerItem, ICapabilityProvider
{
    ...
    {
        CompoundNBT tagCompound = container.func_77978_p();
    ...
    protected void setFluid(FluidStack fluid)
    {
        ...
        container.func_77978_p().func_218657_a(FLUID_NBT_KEY, fluidTag);
    }
    ...
    {
        if (container.func_190916_E() != 1 || resource.isEmpty() || !canFillFluidType(resource))
        {
            return 0;
        }
    ...
    {
        if (container.func_190916_E() != 1 || resource.isEmpty() || !resource.isFluidEqual(getFluid()))
        {
            return FluidStack.EMPTY;
        }
    ...
    {
        container.func_196083_e(FLUID_NBT_KEY);
    }
