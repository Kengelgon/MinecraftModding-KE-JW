...
public class CapabilityFluidHandler
{
    ...
    public static void register()
    {
        ...
        CapabilityManager.INSTANCE.register(IFluidHandlerItem.class, new DefaultFluidHandlerStorage<>(), () -> new FluidHandlerItemStack(new ItemStack(Items.field_151133_ar), FluidAttributes.BUCKET_VOLUME));
    }
