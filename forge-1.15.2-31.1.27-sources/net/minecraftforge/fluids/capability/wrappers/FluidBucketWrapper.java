...
public class FluidBucketWrapper implements IFluidHandlerItem, ICapabilityProvider
{
    ...
    {
        if (fluid.getFluid() == Fluids.field_204546_a || fluid.getFluid() == Fluids.field_204547_b || fluid.getFluid().getRegistryName().equals(new ResourceLocation("milk")))
        {
            return true;
        }
    ...
    {
        if (container.func_190916_E() != 1 || resource.getAmount() < FluidAttributes.BUCKET_VOLUME || container.func_77973_b() instanceof MilkBucketItem || !getFluid().isEmpty() || !canFillFluidType(resource))
        {
            return 0;
        }
    ...
    {
        if (container.func_190916_E() != 1 || resource.getAmount() < FluidAttributes.BUCKET_VOLUME)
        {
            return FluidStack.EMPTY;
        }
    ...
    {
        if (container.func_190916_E() != 1 || maxDrain < FluidAttributes.BUCKET_VOLUME)
        {
            return FluidStack.EMPTY;
        }
